...
/// [field] 为 [TxCheckboxField] 的 [TxWrapFieldTile]
    ...
    Color? textColor,
        ...
        super(
          itemBuilder: (context, index, data, onChanged) {
            ...
            if (minCount != null) {
              effectiveEnabled =
                  effectiveEnabled && (!value || data.length > minCount);
            }
            ...
            return TxCheckboxCell(
              ...
              tristate:
                  tristateMapper == null ? null : tristateMapper(index, item),
              checkboxShape: checkboxShape,
