...
import '../extensions/rrect_extension.dart';
import '../utils.dart';
...
class BarChartPainter extends AxisChartPainter<BarChartData> {
  ...
  void drawTouchTooltip(
    ...
    double innerWidth = textWidth;
    double innerHeight = textHeight;
    if (tooltipItem.indicator != null) {
      innerWidth += tooltipItem.indicator!.width + _gap;
      innerHeight = max(innerHeight, tooltipItem.indicator!.height);
    }
    final double tooltipWidth =
        innerWidth + tooltipData.tooltipPadding.horizontal;
    final double tooltipHeight =
        innerHeight + tooltipData.tooltipPadding.vertical;
    ...
    final textRotationOffset =
        ChartUtils().calculateRotationOffset(tp.size, rotateAngle);
    ...
    canvasWrapper.drawRotated(
      ...
      drawCallback: () {
        ...
        final FlTooltipIndicator? indicator = tooltipItem.indicator;
