...
///
/// We wrapped the canvas here, because we needed to write tests for our
/// drawing system.
/// Now in tests we can verify that these functions called with a specific
/// value.
class CanvasWrapper {
  CanvasWrapper(
    this.canvas,
  ...
  void drawRotated({
    ...
    rotate(ChartUtils().radians(angle));
    translate(
