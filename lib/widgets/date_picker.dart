...
class TxCupertinoMonthPicker extends TxCupertinoPicker<DateTime> {
  ...
  DateTime? get minimumValue => _minimumDate == null
      ? null
      : DateTime(_minimumDate!.year, _minimumDate!.month);

  DateTime? get maximumValue => _maximumDate == null
      ? null
...
class TxCupertinoDatePicker extends TxCupertinoMonthPicker {
  ...
  DateTime? get minimumValue => _minimumDate == null
      ? null
      : DateTime(_minimumDate!.year, _minimumDate!.month, _minimumDate!.day);

  @override
  DateTime? get maximumValue => _maximumDate == null
      ? null
      : DateTime(_maximumDate!.year, _maximumDate!.month, _maximumDate!.day);
