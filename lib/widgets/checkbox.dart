...
enum _TxCheckboxType { material, adaptive }
...
/// a [TxCheckbox] with a [MaterialStateProperty].
/// In this example, the checkbox's color will be `Colors.blue` when the
/// [TxCheckbox] is being pressed, hovered, or focused. Otherwise, the
/// checkbox's color will be `Colors.red`.
///
...
/// See also:
///
///  * [TxCheckboxListTile], which combines this widget with a [ListTile] so
///  that you can give the checkbox a label.
///  * [Switch], a widget with semantics similar to [TxCheckbox].
...
class TxCheckbox extends StatefulWidget {
  ...
  /// Creates an adaptive [TxCheckbox] based on whether the target platform is
  /// iOS or macOS, following Material design's
  /// [Cross-platform guidelines](https://material.io/design/platform-guidance/cross-platform-adaptation.html).
  ///
  /// On iOS and macOS, this constructor creates a [CupertinoCheckbox], which
  /// has matching functionality and presentation as Material checkboxes, and
  /// are the graphics expected on iOS. On other platforms, this creates a
  /// Material design [TxCheckbox].
  ///
  ...
  /// of the [TxCheckbox], providing a different [Color] when it is
  /// [MaterialState.disabled].
  ///
  /// ```dart
  /// TxCheckbox(
  ...
  ///
  /// [TxCheckbox] displays a dash when its value is null.
  ///
  ...
  /// The color for the checkbox's [Material] when a pointer is hovering over
  /// it.
  ///
  ...
  /// a [RoundedRectangleBorder] with a circular corner radius of 1.0 in
  /// Material 2, and 2.0 in Material 3.
  ...
  /// when this is true. This is only used when [ThemeData.useMaterial3] is set
  /// to true.
  /// {@endtemplate}
  ///
  /// Defaults to false.
  ...
  /// The semantic label for the checkobox that will be announced by screen
  /// readers.
  ///
  ...
  final _TxCheckboxType _checkboxType;

  @override
  State<TxCheckbox> createState() => _TxCheckboxState();
}
...
class _TxCheckboxState extends State<TxCheckbox>
  ...
  @override
  void didUpdateWidget(TxCheckbox oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final CheckboxThemeData defaults = _TxCheckboxDefaultsM3(context);
...
const double _kEdgeSize = TxCheckbox.width;
...
class _TxCheckboxDefaultsM3 extends CheckboxThemeData {
  _TxCheckboxDefaultsM3(BuildContext context)
...
// END GENERATED TOKEN PROPERTIES - TxCheckbox
